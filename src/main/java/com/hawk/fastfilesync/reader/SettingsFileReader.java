package com.hawk.fastfilesync.reader;
...
/**
 * Utility class for reading application settings from a JSON file.
 * Provides methods to read existing settings or create a settings file with default values
 * if none exists.
 */
public class SettingsFileReader {
  ...
  /**
   * Returns a map of default settings.
   *
   * @return a map containing default settings key-value pairs
   */
